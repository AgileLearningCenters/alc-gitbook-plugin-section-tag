...
node-sass src/scss/website.scss _assets/website/alc-style.css
node-sass src/scss/ebook.scss _assets/ebook/alc-ebook.css
node-sass src/scss/epub.scss _assets/ebook/alc-epub.css
node-sass src/scss/mobi.scss _assets/ebook/alc-mobi.css
node-sass src/scss/pdf.scss _assets/ebook/alc-pdf.css
